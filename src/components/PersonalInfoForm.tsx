...
export function PersonalInfoForm({
  ...
  const pickPhoto = async () => {
    ...
    if (path && typeof path === "string" && onDesignChange) {
      onDesignChange({ ...d, photo_path: path });
    }
  };
        ...
        <>
          ...
          <div>
            ...
            <button
              type="button"
              onClick={pickPhoto}
              className="mt-1 block rounded-lg border border-dashed border-gray-300 px-3 py-2 text-sm dark:border-gray-600"
            >
